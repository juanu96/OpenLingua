...
final class Menus implements Module {
	...
	public static function page() {
		...
		echo '<p class="description">' . esc_html__( 'Languages without a published translation of the current content are hidden automatically. Footer placement remains available under OpenLingua → Language switcher.', 'openlingua' ) . '</p></section>';
